...
void windValues() {
  ...
  windData += "\t\tTemperature " + String(temp.temperature) + " deg C\n";

  /* Display the results (acceleration is measured in m/s^2) */
  windData += "\t\tAccel X: " + String(accel.acceleration.x) + " m/s^2";
  windData += "\tAccel Y: " + String(accel.acceleration.y) + " m/s^2";
  windData += "\tAccel Z: " + String(accel.acceleration.z) + " m/s^2\n";

  /* Display the results (rotation is measured in rad/s) */
  windData += "\t\tGyro X: " + String(gyro.gyro.x) + " radians/s";
  windData += "\tGyro Y: " + String(gyro.gyro.y) + " radians/s";
  windData += "\tGyro Z: " + String(gyro.gyro.z) + " radians/s\n";
