...
void windValues() {
  ...
  mySerial.print(" Temperature: " + String(temp.temperature) + " deg C");

  /* Display the results (acceleration is measured in m/s^2) */
  mySerial.print(" Accel X: " + String(accel.acceleration.x) + " m/s^2\n");
  mySerial.print(" Accel Y: " + String(accel.acceleration.y) + " m/s^2\n");
  mySerial.print(" Accel Z: " + String(accel.acceleration.z) + " m/s^2\n");

  /* Display the results (rotation is measured in rad/s) */
  mySerial.print(" Gyro X: " + String(gyro.gyro.x) + " radians/s\n");
  mySerial.print(" Gyro Y: " + String(gyro.gyro.y) + " radians/s\n");
  mySerial.print(" Gyro Z: " + String(gyro.gyro.z) + " radians/s\n");

  Serial.print(" Temperature: " + String(temp.temperature) + " deg C");

  /* Display the results (acceleration is measured in m/s^2) */
  Serial.print(" Accel X: " + String(accel.acceleration.x) + " m/s^2\n");
  Serial.print(" Accel Y: " + String(accel.acceleration.y) + " m/s^2\n");
  Serial.print(" Accel Z: " + String(accel.acceleration.z) + " m/s^2\n");

  /* Display the results (rotation is measured in rad/s) */
  Serial.print(" Gyro X: " + String(gyro.gyro.x) + " radians/s\n");
  Serial.print(" Gyro Y: " + String(gyro.gyro.y) + " radians/s\n");
  Serial.print(" Gyro Z: " + String(gyro.gyro.z) + " radians/s\n");
